#!/usr/bin/env python3
"""
Script de déploiement RAPIDE du CRM sur VPS
Version sans mise à jour système - pour déploiement rapide
"""
...
def main():
    print("""
    ╔═══════════════════════════════════════════════════════════╗
    ║   🚀 DÉPLOIEMENT RAPIDE CRM ECO HABITAT CONSULTING       ║
    ║   VPS: 217.182.171.179                                    ║
    ║   Domaine: crm-ehc.fr                                     ║
    ║   Mode: FAST (sans mise à jour système)                  ║
    ╚═══════════════════════════════════════════════════════════╝
    """)
    ...
    try:
        # ÉTAPE 1: Installation des dépendances (sans update système)
        execute_command(ssh,
            "sudo apt install -y git curl nginx certbot python3-certbot-nginx nodejs npm",
            "ÉTAPE 1/7: Installation Git, Nginx, Certbot, Node.js")
        ...
        execute_command(ssh,
            ...
            "ÉTAPE 2/7: Installation de PM2")

        # ÉTAPE 3: Arrêt et suppression de l'ancien projet si existe
        print("\nÉTAPE 3/7: Nettoyage de l'ancien projet")
        ...
        execute_command(ssh,
            ...
            "ÉTAPE 4/7: Clone du projet GitHub")
        ...
        print("\nÉTAPE 5/7: Configuration et installation du Backend")
...
"""
        ...
        print("\nÉTAPE 6/7: Configuration et build du Frontend")
...
"""
        ...
        print("\nÉTAPE 7/7: Configuration Nginx et démarrage")
...
🎯 PRÊT À TESTER LES 11 MODIFICATIONS DE CE MATIN !
