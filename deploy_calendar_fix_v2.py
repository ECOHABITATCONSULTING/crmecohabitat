#!/usr/bin/env python3
"""
DÉPLOIEMENT DU FIX CALENDAR V2 (avec sudo pour dist)
"""
...
print("🔧 DÉPLOIEMENT DU FIX CALENDAR V2\n")
...
try:
    ...
    # Supprimer dist avec sudo
    exec_cmd(ssh,
        f"sudo rm -rf {PROJECT_DIR}/frontend/dist",
        "1/5: Suppression dist (sudo)")

    # Supprimer node_modules et .vite
    exec_cmd(ssh,
        f"cd {PROJECT_DIR}/frontend && rm -rf node_modules .vite",
        "2/5: Nettoyage node_modules")
    ...
    print("\n🎯 Le conflit Calendar / CalendarIcon est résolu !")
